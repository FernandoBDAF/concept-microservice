...
[CONCEPTUAL_REVIEW.md](../review/CONCEPTUAL_REVIEW.md) and the
[PRD](../PRD.md) open questions.

Reference write-up (from v1 verification, before this folder existed): the
token-validate rate-limit incident — see CONCEPTUAL_REVIEW §2 and EXP-08,
which reproduces it on demand.
