...
> *Migrated from legacy_project/reference-materials/development/tools/grafana.md*

## Overview

Grafana is our primary visualization and monitoring tool, used to create dashboards, set up alerts, and analyze metrics from various data sources. This guide covers our Grafana implementation, best practices, and common patterns used across our architecture.
