...
> *Migrated from legacy_project/reference-materials/development/tools/prometheus.md*

## Overview

Prometheus is an open-source monitoring and alerting system. In our architecture, we use Prometheus to collect metrics from our services, monitor their health, and trigger alerts when necessary.
